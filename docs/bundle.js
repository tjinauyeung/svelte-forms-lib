...
`;
    ...
    const code = prism.highlight(source, prism.languages.svelte, "svelte");
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      let pre;
      onMount(() => {
        pre.innerHTML = code; $$invalidate('pre', pre);
      });
    	...
    	return { code, pre, pre_1_binding };
    }

    class Code extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment, safe_not_equal, ["code"]);
    	}
    }

    /* docs-src/components/Basic.svelte generated by Svelte v3.10.0 */

    function create_fragment$1(ctx) {
    	var h1, t1, p, t3, form_1, label0, t5, input0, t6, label1, t8, input1, t9, button, t11, current, dispose;

    	var code_1 = new Code({ props: { code: code } });
    	...
    	return {
    		...
    		p(changed, ctx) {
    			...
    			var code_1_changes = {};
    			if (changed.code) code_1_changes.code = code;
...
`;
    ...
    const code$1 = prism.highlight(source$1, prism.languages.svelte, "svelte");

    /* docs-src/components/Yup.svelte generated by Svelte v3.10.0 */
    ...
    function create_fragment$2(ctx) {
    	var h1, t1, p, t5, form_1, label0, t7, input0, t8, t9, label1, t11, input1, t12, t13, button, t15, pre_1, dispose;
    ...
    function instance$2($$self, $$props, $$invalidate) {
      ...
      let pre;
      onMount(() => {
        pre.innerHTML = code$1; $$invalidate('pre', pre);
      });
    ...
    class Yup extends SvelteComponent {
    	constructor(options) {
    		super();
...
`;
    ...
    const code$2 = prism.highlight(source$2, prism.languages.svelte, "svelte");

    /* docs-src/components/Custom.svelte generated by Svelte v3.10.0 */

    // (37:2) {#if $errors.name}
    function create_if_block_1$1(ctx) {
    	var hint, t_value = ctx.$errors.name + "", t;

    	return {
    		c() {
    			hint = element("hint");
    			t = text(t_value);
    			attr(hint, "class", "error");
    		},

    		m(target, anchor) {
    			insert(target, hint, anchor);
    			append(hint, t);
    		},
    ...
    // (43:2) {#if $errors.email}
    function create_if_block$1(ctx) {
    	var hint, t_value = ctx.$errors.email + "", t;
    ...
    function create_fragment$3(ctx) {
    	var h1, t1, p, t3, form_1, label0, t5, input0, t6, t7, label1, t9, input1, t10, t11, button, t13, current, dispose;

    	var if_block0 = (ctx.$errors.name) && create_if_block_1$1(ctx);

    	var if_block1 = (ctx.$errors.email) && create_if_block$1(ctx);

    	var code_1 = new Code({ props: { code: code$2 } });
    	...
    	return {
    		...
    		p(changed, ctx) {
    			...
    			var code_1_changes = {};
    			if (changed.code) code_1_changes.code = code$2;
    			code_1.$set(code_1_changes);
    		},
...
`;
    ...
    const code$3 = prism.highlight(source$3, prism.languages.svelte, "svelte");

    /* docs-src/components/Array.svelte generated by Svelte v3.10.0 */

    function add_css() {
    	var style = element("style");
    	style.id = 'svelte-1q6k8lj-style';
    	style.textContent = ".error.svelte-1q6k8lj{display:block;color:red;font-size:12px}.form-group.svelte-1q6k8lj{display:flex;align-items:baseline}.form-title.svelte-1q6k8lj{font-size:18px;font-weight:600;margin:0}.push-right.svelte-1q6k8lj{margin-right:15px}.flex.svelte-1q6k8lj{display:flex}";
    ...
    function create_if_block_3(ctx) {
    	var hint, t_value = ctx.$errors.users[ctx.j].name + "", t;

    	return {
    		c() {
    			hint = element("hint");
    			t = text(t_value);
    			attr(hint, "class", "error svelte-1q6k8lj");
    		},
    ...
    function create_if_block_2(ctx) {
    	var hint, t_value = ctx.$errors.users[ctx.j].email + "", t;
    ...
    function create_if_block_1$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "push-right svelte-1q6k8lj");
    ...
    function create_each_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "push-right svelte-1q6k8lj");
    			attr(input1, "placeholder", "email");
    			attr(input1, "name", `users[${ctx.j}].email`);
    			attr(div1, "class", "push-right svelte-1q6k8lj");
    			attr(div2, "class", "form-group svelte-1q6k8lj");
    ...
    function create_fragment$4(ctx) {
    	var h10, t1, p, t4, form_1, h11, t6, t7, div, button0, t9, button1, t11, current, dispose;
    	...
    	var code_2 = new Code({ props: { code: code$3 } });

    	return {
    		c() {
    			h10 = element("h1");
    			h10.textContent = "Array";
    			t1 = space();
    			p = element("p");
    			p.innerHTML = `
			  ...
			  <code>\$forms.users[i].name</code>`;
    			...
    			t11 = space();
    			code_2.$$.fragment.c();
    			attr(h11, "class", "form-title svelte-1q6k8lj");
    			attr(button0, "type", "button");
    			attr(button0, "class", "push-right svelte-1q6k8lj");
    			attr(button1, "type", "button");
    			attr(div, "class", "flex svelte-1q6k8lj");
    		...
    		m(target, anchor) {
    			...
    			append(div, button1);
    			insert(target, t11, anchor);
    			mount_component(code_2, target, anchor);
    			current = true;
    		},
    		...
    		p(changed, ctx) {
    			...
    			var code_2_changes = {};
    			if (changed.code) code_2_changes.code = code$3;
    			code_2.$set(code_2_changes);
    		},

    		i(local) {
    			if (current) return;
    			transition_in(code_2.$$.fragment, local);

    			current = true;
    		},

    		o(local) {
    			transition_out(code_2.$$.fragment, local);
    			current = false;
    		},
    		...
    		d(detaching) {
    			...
    			destroy_component(code_2, detaching);
    ...
    class Array$1 extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-1q6k8lj-style")) add_css();
...
`;
    ...
    const code$4 = prism.highlight(source$4, prism.languages.svelte, "svelte");

    /* docs-src/components/Helpers.svelte generated by Svelte v3.10.0 */
    ...
    function create_fragment$5(ctx) {
    	...
    	var code_1 = new Code({ props: { code: code$4 } });

    	return {
    		c() {
    			p = element("p");
    			p.textContent = "Example Form, Field and ErrorMessage helper components.";
    			t1 = space();
    			form.$$.fragment.c();
    			t2 = space();
    			code_1.$$.fragment.c();
    		...
    		p(changed, ctx) {
    			...
    			var code_1_changes = {};
    			if (changed.code) code_1_changes.code = code$4;
    			code_1.$set(code_1_changes);
    		},
    ...
    class Helpers extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    function add_css$1() {
    	var style = element("style");
    	style.id = 'svelte-8vdrpi-style';
    	style.textContent = ":root{--primary:#000;--primary-lighter:#f2f2f2}.layout.svelte-8vdrpi{display:flex;padding:50px}.aside.svelte-8vdrpi{margin-right:100px}nav.svelte-8vdrpi{display:flex;flex-direction:column;margin-top:50px}.main.svelte-8vdrpi{max-width:768px;width:100%}.logo.svelte-8vdrpi{max-width:182.5px}";
    	append(document.head, style);
    }
    ...
    function create_default_slot$1(ctx) {
    	var div, aside, img, t0, nav, t1, t2, t3, t4, t5, main, t6, t7, t8, t9, current;
    	...
    	var route0 = new Route({
    		props: { path: "/basic", component: Basic }
    	});

    	var route1 = new Route({
    		props: { path: "/yup", component: Yup }
    	});

    	var route2 = new Route({
    		props: { path: "/array", component: Array$1 }
    	});
    	...
    	return {
    		c() {
    			...
    			attr(img, "class", "logo svelte-8vdrpi");
    			attr(img, "src", "./logo.png");
    			attr(nav, "class", "svelte-8vdrpi");
    			attr(aside, "class", "aside svelte-8vdrpi");
    			attr(main, "class", "main svelte-8vdrpi");
    			attr(div, "class", "layout svelte-8vdrpi");
    		},
    		...
    		p(changed, ctx) {
    			...
    			var route0_changes = {};
    			if (changed.Basic) route0_changes.component = Basic;
    			route0.$set(route0_changes);

    			var route1_changes = {};
    			if (changed.YupValidation) route1_changes.component = Yup;
    			route1.$set(route1_changes);

    			var route2_changes = {};
    			if (changed.FormArray) route2_changes.component = Array$1;
    			route2.$set(route2_changes);

    			var route3_changes = {};
    			if (changed.CustomValidation) route3_changes.component = Custom;
    			route3.$set(route3_changes);

    			var route4_changes = {};
    			if (changed.Helpers) route4_changes.component = Helpers;
    ...
    class Index extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-8vdrpi-style")) add_css$1();
